...
% partFeatures(["speckled","mottled","tufted","striped","narrow","oversized"]).
...
% such things birds see some totally different shades of blue and
% off-blue, particularly some ultraviolet ones, and possess plumage
...
clime_somePlace(WHAT_PLACE,SOMEWHERE_IN_IT).
...
distribution_sentence(LISTED_BIRD,DIST_SENT):-
	...
	strs_flatten(["They are ",HOW_MANYLY," found in bushes by ",WHERE_POINTED," ",WHAT_WEATHER,", ",WHERE,"."],DIST_SENT).
...
% I do know airplanes though: the absence, presence, or doubling of
% winglets; the difference in cockpit curvature distinguishing between
% Airbus A330 and Boeing 767; the common 2-engined, the rare hulking
% 4-engined, the little buzzing turbo-props, the now rare, most commonly
% found taxiing on non-Western landing-strips where gates are replaced
% by busses and mobile staircases, 3-engined. From the inside, 3-3,
% 2-3-2, 3-3-3, or 3-4-3 economy seating arrangements, the depth of
% overhead bins the new possibility of blue gradients on the ceiling,
% and of extra large windows.
